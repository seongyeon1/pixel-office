...
48×64 픽셀의 캐릭터에 머릿결 명암, 눈동자 반사광, 재킷·사원증 디테일을 넣었습니다. 헤어스타일 6종과 머리색·피부색·안경 조합은 세션 ID로 정해져 새로고침 후에도 유지됩니다. Claude는 따뜻한 재킷, Codex는 파란 재킷으로 구분합니다. 오피스와 상세 패널은 같은 픽셀 원본을 사용합니다.
